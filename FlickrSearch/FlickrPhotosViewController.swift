...
private extension FlickrPhotosViewController {
    ...
    func photoForIndexPath(_ indexPath: IndexPath) -> FlickrPhoto {
        return searches[indexPath.section].searchResults[(indexPath as IndexPath).row]
    }
    
    func updateSharedPhotoCount() {
        shareTextLabel.textColor = AppDelegate.themeColor
...
extension FlickrPhotosViewController : UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        flickr.searchFlickrForTerm(textField.text!) { [unowned self] results, error in
...
extension FlickrPhotosViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String,
        ...
        case UICollectionElementKindSectionHeader:
            guard let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: kind,
                                                                                   withReuseIdentifier: FlickrPhotoHeaderView.identifier,
                                                                                   for: indexPath) as? FlickrPhotoHeaderView else {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //2
        guard let largePhotoIndexPath = largePhotoIndexPath, indexPath == largePhotoIndexPath else {
